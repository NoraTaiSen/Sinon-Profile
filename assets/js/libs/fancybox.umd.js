!function (t, e) {
    ...
    const e = (t, e = 1e4) => (t = parseFloat(t + "") || 0, Math.round((t + Number.EPSILON) * e) / e), i = function (t) {
      ...
      t && o(e).forEach(e => {
        t.classList.toggle(e, i || false);
      });
    };
    class r {
      constructor(t) {
        Object.defineProperty(this, "pageX", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "pageY", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "clientX", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "clientY", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "id", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "time", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "nativePointer", {enumerable: true, configurable: true, writable: true, value: undefined}), this.nativePointer = t, this.pageX = t.pageX, this.pageY = t.pageY, this.clientX = t.clientX, this.clientY = t.clientY, this.id = self.Touch && t instanceof Touch ? t.identifier : -1, this.time = Date.now();
      }
    }
    const l = {passive: false};
    class c {
      constructor(t, {start: e = () => true, move: i = () => {}, end: n = () => {}}) {
        Object.defineProperty(this, "element", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "startCallback", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "moveCallback", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "endCallback", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "currentPointers", {enumerable: true, configurable: true, writable: true, value: []}), Object.defineProperty(this, "startPointers", {enumerable: true, configurable: true, writable: true, value: []}), this.element = t, this.startCallback = e, this.moveCallback = i, this.endCallback = n;
      ...
      onMove(t) {
        const e = this.currentPointers.slice(), i = "changedTouches" in t ? Array.from(t.changedTouches || []).map(t => new r(t)) : [new r(t)], n = [];
        for (const t of i) {
      ...
      clear() {
        for (; this.currentPointers.length;) {
          ...
          this.currentPointers.splice(this.currentPointers.length - 1, 1), this.startPointers.splice(this.currentPointers.length - 1, 1), this.endCallback(new Event("touchend", {bubbles: true, cancelable: true, clientX: t.clientX, clientY: t.clientY}), t, this.currentPointers.slice());
        }
      }
      stop() {
    ...
    const u = t => "object" == typeof t && null !== t && t.constructor === Object && "[object Object]" === Object.prototype.toString.call(t), p = (t, ...e) => {
      const i = e.length;
      for (let n = 0; n < i; n++) {
        const i = e[n] || {};
    ...
    class g {
      constructor(t = {}) {
        Object.defineProperty(this, "options", {enumerable: true, configurable: true, writable: true, value: t}), Object.defineProperty(this, "events", {enumerable: true, configurable: true, writable: true, value: new Map}), this.setOptions(t);
      ...
      option(t, ...e) {
        let i = t.split(".").reduce((t, e) => "object" == typeof t ? t[this.options] : undefined, this.options);
        return i && "function" == typeof i && (i = i.call(this, this, ...e)), i;
      }
      optionFor(t, e, i, ...n) {
        let s = e.split(".").reduce((t, e) => "object" == typeof e ? e[t] : undefined, t);
        var o;
        "string" != typeof (o = s) || isNaN(o) || isNaN(parseFloat(o)) || (s = parseFloat(s)), "true" === s && (s = true), "false" === s && (s = false), s && "function" == typeof s && (s = s.call(this, this, t, ...n));
        let a = e.split(".").reduce((t, e) => "object" == typeof e ? e[this.options] : undefined, this.options);
        return a && "function" == typeof a ? s = a.call(this, this, t, ...n, s) : undefined === s && (s = a), undefined === s ? i : s;
      }
      cn(t) {
    ...
    class m extends g {
      constructor(t = {}) {
        super(t), Object.defineProperty(this, "plugins", {enumerable: true, configurable: true, writable: true, value: {}});
      }
      attachPlugins(t = {}) {
        const e = new Map;
        for (const [i, n] of Object.entries(t)) {
          const t = this.option(i), s = this.plugins[i];
          s || false === t ? s && false === t && (s.detach(), delete this.plugins[i]) : e.set(i, new n(this, t || {}));
        }
    ...
    class D extends m {
      ...
      get isResting() {
        ...
        for (const t of b) {
          const e = "e" == t || "f" === t ? 0.0001 : 0.00001;
      ...
      constructor(t, e = {}, i = {}) {
        var n;
        if (super(e), Object.defineProperty(this, "pointerTracker", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "resizeObserver", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "updateTimer", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "clickTimer", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "rAF", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "isTicking", {enumerable: true, configurable: true, writable: true, value: false}), Object.defineProperty(this, "ignoreBounds", {enumerable: true, configurable: true, writable: true, value: false}), Object.defineProperty(this, "isBouncingX", {enumerable: true, configurable: true, writable: true, value: false}), Object.defineProperty(this, "isBouncingY", {enumerable: true, configurable: true, writable: true, value: false}), Object.defineProperty(this, "clicks", {enumerable: true, configurable: true, writable: true, value: 0}), Object.defineProperty(this, "trackingPoints", {enumerable: true, configurable: true, writable: true, value: []}), Object.defineProperty(this, "pwt", {enumerable: true, configurable: true, writable: true, value: 0}), Object.defineProperty(this, "cwd", {enumerable: true, configurable: true, writable: true, value: 0}), Object.defineProperty(this, "pmme", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "friction", {enumerable: true, configurable: true, writable: true, value: 0}), Object.defineProperty(this, "state", {enumerable: true, configurable: true, writable: true, value: v.Init}), Object.defineProperty(this, "isDragging", {enumerable: true, configurable: true, writable: true, value: false}), Object.defineProperty(this, "container", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "content", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "spinner", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "containerRect", {enumerable: true, configurable: true, writable: true, value: {width: 0, height: 0, innerWidth: 0, innerHeight: 0}}), Object.defineProperty(this, "contentRect", {enumerable: true, configurable: true, writable: true, value: {top: 0, right: 0, bottom: 0, left: 0, fullWidth: 0, fullHeight: 0, fitWidth: 0, fitHeight: 0, width: 0, height: 0}}), Object.defineProperty(this, "dragStart", {enumerable: true, configurable: true, writable: true, value: {x: 0, y: 0, top: 0, left: 0, time: 0}}), Object.defineProperty(this, "dragOffset", {enumerable: true, configurable: true, writable: true, value: {x: 0, y: 0, time: 0}}), Object.defineProperty(this, "current", {enumerable: true, configurable: true, writable: true, value: Object.assign({}, T)}), Object.defineProperty(this, "target", {enumerable: true, configurable: true, writable: true, value: Object.assign({}, T)}), Object.defineProperty(this, "velocity", {enumerable: true, configurable: true, writable: true, value: {a: 0, b: 0, c: 0, d: 0, e: 0, f: 0}}), Object.defineProperty(this, "lockedAxis", {enumerable: true, configurable: true, writable: true, value: false}), !t) throw new Error("Container Element Not Found");
        ...
        if (o.addEventListener("load", this.onLoad), o.addEventListener("error", this.onError), this.isContentLoading) {
          if (this.option("spinner")) {
            ...
            const e = s(E);
            !t.contains(o) || o.parentElement instanceof HTMLPictureElement ? this.spinner = t.appendChild(e) : this.spinner = (null === (n = o.parentElement) || undefined === n ? undefined : n.insertBefore(e, o)) || null;
          }
      ...
      getNextScale(t) {
        ...
        switch (t) {
          ...
          case "toggleZoom":
            ...
            break;
          case "iterateZoom":
            let t = [1, e, s].sort((t, e) => t - e), r = t.findIndex(t => t > i + 0.00001);
            a = t[r] || 1;
        }
        return a;
      }
      attachObserver() {
        ...
        this.resizeObserver || undefined === window.ResizeObserver || (this.resizeObserver = new ResizeObserver(() => {
          this.updateTimer || (e() ? (this.onResize(), this.isMobile && (this.updateTimer = setTimeout(() => {
            e() && this.onResize(), this.updateTimer = null;
          }, 500))) : this.updateTimer && (clearTimeout(this.updateTimer), this.updateTimer = null));
        })), null === (t = this.resizeObserver) || undefined === t || t.observe(this.container);
      }
      detachObserver() {
        var t;
        null === (t = this.resizeObserver) || undefined === t || t.disconnect();
      }
      attachEvents() {
        const {container: t} = this;
        t.addEventListener("click", this.onClick, {passive: false, capture: false}), t.addEventListener("wheel", this.onWheel, {passive: false}), this.pointerTracker = new c(t, {start: this.onPointerDown, move: this.onPointerMove, end: this.onPointerUp}), document.addEventListener(A, this.onMouseMove);
      }
      detachEvents() {
        var t;
        const {container: e} = this;
        e.removeEventListener("click", this.onClick, {passive: false, capture: false}), e.removeEventListener("wheel", this.onWheel, {passive: false}), null === (t = this.pointerTracker) || undefined === t || t.stop(), this.pointerTracker = null, document.removeEventListener(A, this.onMouseMove), document.removeEventListener("keydown", this.onKeydown, true), this.clickTimer && (clearTimeout(this.clickTimer), this.clickTimer = null), this.updateTimer && (clearTimeout(this.updateTimer), this.updateTimer = null);
      }
      animate() {
        this.setTargetForce();
      ...
      checkBounds(t = 0, e = 0) {
        ...
        let u = 0, p = 0;
        return l !== Infinity && n < l ? u = l - n : c !== Infinity && n > c && (u = c - n), h !== Infinity && s < h ? p = h - s : d !== Infinity && s > d && (p = d - s), Math.abs(u) < 0.0001 && (u = 0), Math.abs(p) < 0.0001 && (p = 0), Object.assign(Object.assign({}, o), {xDiff: u, yDiff: p, inBounds: !u && !p});
      }
      clampTargetBounds() {
      ...
      setEdgeForce() {
        ...
        0 !== n ? (this.isBouncingX = true, n * a <= 0 ? a += 0.14 * n : (a = 0.14 * n, e.min !== Infinity && (this.target.e = Math.max(t.e, e.min)), e.max !== Infinity && (this.target.e = Math.min(t.e, e.max))), o && (a = Math.max(Math.min(a, o), -1 * o))) : this.isBouncingX = false, 0 !== s ? (this.isBouncingY = true, s * r <= 0 ? r += 0.14 * s : (r = 0.14 * s, i.min !== Infinity && (this.target.f = Math.max(t.f, i.min)), i.max !== Infinity && (this.target.f = Math.min(t.f, i.max))), o && (r = Math.max(Math.min(r, o), -1 * o))) : this.isBouncingY = false, this.isBouncingX && (this.velocity.e = a), this.isBouncingY && (this.velocity.f = r);
      }
      enable() {
      ...
      onClick(t) {
        var e;
        "click" === t.type && 0 === t.detail && (this.dragOffset.x = 0, this.dragOffset.y = 0), this.isDragging && (null === (e = this.pointerTracker) || undefined === e || e.clear(), this.trackingPoints = [], this.startDecelAnim());
        const i = t.target;
        ...
        const n = i.closest("[data-panzoom-action]"), s = i.closest("[data-panzoom-change]"), o = n || s, a = o && S(o) ? o.dataset : null;
        if (a) {
      ...
      onPointerDown(t, e, i) {
        var n;
        if (false === this.option("touch", t)) return false;
        this.pwt = 0, this.dragOffset = {x: 0, y: 0, time: 0}, this.trackingPoints = [];
        const s = this.content.getBoundingClientRect();
        if (this.dragStart = {x: s.x, y: s.y, top: s.top, left: s.left, time: Date.now()}, this.clickTimer) return false;
        if (this.panMode === A && this.targetScale > 1) return t.preventDefault(), t.stopPropagation(), false;
        const o = t.composedPath()[0];
        if (!i.length) {
          if (["TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO", "IFRAME"].includes(o.nodeName) || o.closest("[contenteditable],[data-selectable],[data-draggable],[data-clickable],[data-panzoom-change],[data-panzoom-action]")) return false;
          null === (n = window.getSelection()) || undefined === n || n.removeAllRanges();
        }
        if ("mousedown" === t.type) ["A", "BUTTON"].includes(o.nodeName) || t.preventDefault(); else if (Math.abs(this.velocity.a) > 0.3) return false;
      ...
      onPointerMove(t, i, s) {
        if (false === this.option("touch", t)) return;
        ...
        this.option("rubberband") ? ("x" !== this.isInfinite && (b.xDiff > 0 && g < 0 || b.xDiff < 0 && g > 0) && (g *= Math.max(0, 0.5 - Math.abs(0.75 / this.contentRect.fitWidth * b.xDiff))), "y" !== this.isInfinite && (b.yDiff > 0 && m < 0 || b.yDiff < 0 && m > 0) && (m *= Math.max(0, 0.5 - Math.abs(0.75 / this.contentRect.fitHeight * b.yDiff)))) : (b.xDiff && (g = 0), b.yDiff && (m = 0));
        const y = this.targetScale, w = this.minScale, x = this.maxScale;
        y < 0.5 * w && (f = Math.max(f, w)), y > 1.5 * x && (f = Math.min(f, x)), "y" === this.lockedAxis && e(y) === e(w) && (g = 0), "x" === this.lockedAxis && e(y) === e(w) && (m = 0), this.applyChange({originX: l, originY: c, panX: g, panY: m, scale: f, friction: this.option("dragFriction"), ignoreBounds: true});
      }
      onPointerUp(t, e, i) {
      ...
      startDecelAnim() {
        ...
        const c = (null === (t = window.visualViewport) || undefined === t ? undefined : t.scale) || 1;
        1 !== c && (a *= c, r *= c);
        ...
        Math.abs(m) < y && Math.abs(v) < y && (h = d = 0, u = p = 0), (this.option("zoom") && (g < this.minScale - 0.00001 || g > this.maxScale + 0.00001) || i && !h && !d) && (f = 0.35), this.applyChange({panX: h, panY: d, friction: f}), this.emit("decel", u, p, m, v);
      }
      onWheel(t) {
        ...
        "pan" === n ? (t.preventDefault(), this.panOnlyZoomed && !this.canZoomOut() || this.applyChange({panX: 2 * -t.deltaX, panY: 2 * -t.deltaY, bounce: false})) : "zoom" === n && false !== this.option("zoom") && this.zoomWithWheel(t);
      }
      onMouseMove(t) {
        this.panWithMouse(t);
      }
      ...
      updateMetrics(t = false) {
        ...
        const n = Math.max(1, (null === (i = window.visualViewport) || undefined === i ? undefined : i.scale) || 1), {container: s, content: o} = this, a = o instanceof HTMLImageElement, r = s.getBoundingClientRect(), l = getComputedStyle(this.container);
        ...
        let O = 0.5 * (M - C), A = 0.5 * (T - P);
        this.contentRect = Object.assign(Object.assign({}, this.contentRect), {top: S.top - r.top + O, bottom: r.bottom - S.bottom + O, left: S.left - r.left + A, right: r.right - S.right + A, fitWidth: P, fitHeight: C, width: P, height: C, fullWidth: m, fullHeight: b}), x.style.cssText = E, a && (x.style.width = `${P}px`, x.style.height = `${C}px`), this.setTransform(), true !== t && this.emit("refresh"), this.ignoreBounds || (e(this.targetScale) < e(this.minScale) ? this.zoomTo(this.minScale, {friction: 0}) : this.targetScale > this.maxScale ? this.zoomTo(this.maxScale, {friction: 0}) : this.state === v.Init || this.checkBounds().inBounds || this.requestTick()), this.updateControls();
      }
      calculateBounds() {
        ...
        if (true === d || s && d === s) r = -Infinity, c = Infinity, l = -Infinity, h = Infinity; else {
      ...
      updateControls() {
        ...
        let l = r, c = t.option("click") || false;
        c && (l = t.getNextScale(c));
        let h = t.canZoomIn(), d = t.canZoomOut(), u = n === L && !!this.option("touch"), p = d && u;
        if (u && (e(o) < e(r) && !this.panOnlyZoomed && (p = true), (e(s.width, 1) > e(s.fitWidth, 1) || e(s.height, 1) > e(s.fitHeight, 1)) && (p = true)), e(s.width * o, 1) < e(s.fitWidth, 1) && (p = false), n === A && (p = false), a(i, this.cn("isDraggable"), p), !this.option("zoom")) return;
      ...
      panTo({x: t = this.target.e, y: e = this.target.f, scale: i = this.targetScale, friction: n = this.option("friction"), angle: s = 0, originX: o = 0, originY: a = 0, flipX: r = false, flipY: l = false, ignoreBounds: c = false}) {
      ...
      applyChange({panX: t = 0, panY: i = 0, scale: n = 1, angle: s = 0, originX: o = -this.current.e, originY: a = -this.current.f, friction: r = this.option("friction"), flipX: l = false, flipY: c = false, ignoreBounds: h = false, bounce: d = this.option("bounce")}) {
        const u = this.state;
        ...
        for (const t of b) "e" !== t && "f" !== t && (y[t] > this.minScale + 0.00001 || y[t] < this.minScale - 0.00001) ? this.target[t] = y[t] : this.target[t] = e(y[t], O);
        (this.targetScale < this.scale || Math.abs(n - 1) > 0.1 || this.panMode === A || false === d) && !h && this.clampTargetBounds(), u === v.Init ? this.animate() : this.isResting || (this.state = v.Panning, this.requestTick());
      }
      stop(t = false) {
        ...
        this.setTransform(), P(this.container, "is-scaling"), P(this.container, "is-animating"), this.isTicking = false, this.state = v.Ready, e && (this.emit("endAnimation"), this.updateControls());
      }
      requestTick() {
      ...
      zoomTo(t = 1, {friction: e = R, originX: i = R, originY: n = R, event: s} = {}) {
        ...
        if (this.stop(), this.panMode === A && (s = this.pmme || s), s || i === R || n === R) {
          const t = this.content.getBoundingClientRect(), e = this.container.getBoundingClientRect(), o = s ? s.clientX : e.left + 0.5 * e.width, a = s ? s.clientY : e.top + 0.5 * e.height;
          i = o - t.left - 0.5 * t.width, n = a - t.top - 0.5 * t.height;
        }
        let c = 1;
        "number" == typeof t ? c = t : "full" === t ? c = a : "cover" === t ? c = l : "max" === t ? c = r : "fit" === t ? c = 1 : "next" === t && (c = this.getNextScale("iterateZoom")), c = c / o || 1, e = e === R ? c > 1 ? 0.15 : 0.25 : e, this.applyChange({scale: c, originX: i, originY: n, friction: e}), s && this.panMode === A && this.panWithMouse(s, e);
      }
      rotateCCW() {
      ...
      fitX() {
        ...
        this.applyChange({panX: 0.5 * t.width - (e.left + 0.5 * e.fitWidth) - i.e, panY: 0.5 * t.height - (e.top + 0.5 * e.fitHeight) - i.f, scale: t.width / e.fitWidth / this.targetScale, originX: 0, originY: 0, ignoreBounds: true});
      }
      fitY() {
        this.stop("target");
        const {containerRect: t, contentRect: e, target: i} = this;
        this.applyChange({panX: 0.5 * t.width - (e.left + 0.5 * e.fitWidth) - i.e, panY: 0.5 * t.innerHeight - (e.top + 0.5 * e.fitHeight) - i.f, scale: t.height / e.fitHeight / this.targetScale, originX: 0, originY: 0, ignoreBounds: true});
      }
      toggleFS() {
      ...
      reset(t) {
        if (this.state !== v.Init && this.state !== v.Destroy) {
          ...
          this.target.a = this.minScale, this.target.d = this.minScale, this.clampTargetBounds(), this.isResting || (this.friction = undefined === t ? this.option("friction") : t, this.state = v.Panning, this.requestTick());
        }
      }
      destroy() {
    ...
    const N = t => {
      if ("string" == typeof t || t instanceof HTMLElement) t = {html: t}; else {
        const e = t.thumb;
        undefined !== e && ("string" == typeof e && (t.thumbSrc = e), e instanceof HTMLImageElement && (t.thumbEl = e, t.thumbElSrc = e.src, t.thumbSrc = e.src), delete t.thumb);
      }
      return Object.assign({html: "", el: null, isDom: false, class: "", customClass: "", index: -1, dim: 0, gap: 0, pos: 0, transition: false}, t);
    }, _ = (t = {}) => Object.assign({index: -1, slides: [], dim: 0, pos: -1}, t);
    class $ extends g {
      constructor(t, e) {
        super(e), Object.defineProperty(this, "instance", {enumerable: true, configurable: true, writable: true, value: t});
      }
      attach() {}
      detach() {}
    }
    const W = {classes: {list: "f-carousel__dots", isDynamic: "is-dynamic", hasDots: "has-dots", dot: "f-carousel__dot", isBeforePrev: "is-before-prev", isPrev: "is-prev", isCurrent: "is-current", isNext: "is-next", isAfterNext: "is-after-next"}, dotTpl: '<button type="button" data-carousel-page="%i" aria-label="{{GOTO}}"><span class="f-carousel__dot" aria-hidden="true"></span></button>', dynamicFrom: 11, maxCount: Infinity, minCount: 2};
    class X extends $ {
      constructor() {
      ...
      refresh() {
        ...
        const o = "number" == typeof s && e > 5 && e >= s, r = !this.list || this.isDynamic !== o || this.list.children.length !== e;
        r && this.cleanup();
        const l = this.build();
        ...
        for (const e of [...l.children]) {
          ...
          i && (c = e), a(e, this.cn("isCurrent"), i), null === (t = e.children[0]) || undefined === t || t.setAttribute("aria-selected", i ? "true" : "false");
      ...
      createItem(t = 0) {
        ...
        return i.appendChild(n), null === (e = i.children[0]) || undefined === e || e.setAttribute("role", "tab"), i;
      }
      cleanup() {
    ...
    class Z extends $ {
      ...
      addBtn(t) {
        ...
        var o;
        return n.innerHTML = i.localize(this.option(`${s}Tpl`)), n.dataset[`carousel${o = t, o ? o.match("^[a-z]") ? o.charAt(0).toUpperCase() + o.substring(1) : o : ""}`] = "true", null === (e = this.container) || undefined === e || e.appendChild(n), n;
      }
      build() {
    ...
    class U extends $ {
      ...
      onNavTouch(t, e, i) {
        ...
        a.slideTo(d), r.slideTo(h, {friction: (null === (s = null === (n = this.nav) || undefined === n ? undefined : n.plugins) || undefined === s ? undefined : s.Sync.option("friction")) || 0}), this.markSelectedSlide(c);
      }
      ...
      onTargetChange() {
        ...
        const s = null === (e = null === (t = i.pages[i.page]) || undefined === t ? undefined : t.slides[0]) || undefined === e ? undefined : e.index, o = n.getPageForSlide(s);
        this.markSelectedSlide(s), n.slideTo(o, null === n.prevPage && null === i.prevPage ? {friction: 0} : undefined);
      }
      markSelectedSlide(t) {
        const e = this.nav;
    ...
    class tt extends m {
      ...
      constructor(t, e = {}, i = {}) {
        if (super(), Object.defineProperty(this, "bp", {enumerable: true, configurable: true, writable: true, value: ""}), Object.defineProperty(this, "lp", {enumerable: true, configurable: true, writable: true, value: 0}), Object.defineProperty(this, "userOptions", {enumerable: true, configurable: true, writable: true, value: {}}), Object.defineProperty(this, "userPlugins", {enumerable: true, configurable: true, writable: true, value: {}}), Object.defineProperty(this, "state", {enumerable: true, configurable: true, writable: true, value: H.Init}), Object.defineProperty(this, "page", {enumerable: true, configurable: true, writable: true, value: 0}), Object.defineProperty(this, "prevPage", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "container", {enumerable: true, configurable: true, writable: true, value: undefined}), Object.defineProperty(this, "viewport", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "track", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "slides", {enumerable: true, configurable: true, writable: true, value: []}), Object.defineProperty(this, "pages", {enumerable: true, configurable: true, writable: true, value: []}), Object.defineProperty(this, "panzoom", {enumerable: true, configurable: true, writable: true, value: null}), Object.defineProperty(this, "inTransition", {enumerable: true, configurable: true, writable: true, value: new Set}), Object.defineProperty(this, "contentDim", {enumerable: true, configurable: true, writable: true, value: 0}), Object.defineProperty(this, "viewportDim", {enumerable: true, configurable: true, writable: true, value: 0}), "string" == typeof t && (t = document.querySelector(t)), !t || !S(t)) throw new Error("No Element found");
      ...
      processOptions() {
        ...
        n === this.bp && this.state !== H.Init || (this.bp = n, this.state === H.Ready && (i.initialSlide = (null === (e = null === (t = this.pages[this.page]) || undefined === t ? undefined : t.slides[0]) || undefined === e ? undefined : e.index) || 0), this.state !== H.Init && this.destroy(), super.setOptions(i), false === this.option("enabled") ? this.attachEvents() : setTimeout(() => {
          this.init();
        }, 0));
      }
      init() {
      ...
      initSlides() {
        ...
        [...j(t, `.${this.cn(Q)}`)].forEach(t => {
          if (S(t)) {
            const e = N({el: t, isDom: true, index: this.slides.length});
            i.push(e);
          }
        });
      ...
      initPanzoom() {
        ...
        this.panzoom = new D(this.viewport, p({}, {content: this.track, zoom: false, panOnlyZoomed: false, lockAxis: this.isHorizontal ? "x" : "y", infinite: this.isInfinite, click: false, dblClick: false, touch: t => !(this.pages.length < 2 && !t.options.infinite), bounds: () => this.getBounds(), maxVelocity: t => Math.abs(t.target[this.axis] - t.current[this.axis]) < 2 * this.viewportDim ? 100 : 0}, t)), this.panzoom.on("*", (t, e, ...i) => {
          this.emit(`Panzoom.${e}`, t, ...i);
        }), this.panzoom.on("decel", this.onDecel), this.panzoom.on("refresh", this.onRefresh), this.panzoom.on("beforeTransform", this.onBeforeTransform), this.panzoom.on("endAnimation", this.onEndAnimation);
      }
      attachEvents() {
        const t = this.container;
        t && (t.addEventListener("click", this.onClick, {passive: false, capture: false}), t.addEventListener("slideTo", this.onSlideTo)), window.addEventListener("resize", this.onResize);
      }
      createPages() {
        let t = [];
        const {contentDim: e, viewportDim: i} = this;
        let n = this.option("slidesPerPage");
        n = ("auto" === n || e <= i) && false !== this.option("fill") ? Infinity : parseFloat(n + "");
        let s = 0, o = 0, a = 0;
        for (const e of this.slides) (!t.length || o + e.dim - i > 0.05 || a >= n) && (t.push(_()), s = t.length - 1, o = 0, a = 0), t[s].slides.push(e), o += e.dim + e.gap, a++;
        return t;
      }
      processPages() {
        const t = this.pages, {contentDim: i, viewportDim: n, isInfinite: s} = this, o = this.option("center"), a = this.option("fill"), r = a && o && i > n && !s;
        if (t.forEach((t, e) => {
          var s;
          t.index = e, t.pos = (null === (s = t.slides[0]) || undefined === s ? undefined : s.pos) || 0, t.dim = 0;
      ...
      getSlideMetrics(t) {
        ...
        if (r ? o = parseFloat(r.dataset[s] || "") || 0 : (r = document.createElement("div"), r.style.visibility = "hidden", (this.track || document.body).prepend(r)), C(r, this.cn(Q) + " " + t.class + " " + t.customClass), o) r.style[s] = `${o}px`, r.style["width" === s ? "height" : "width"] = ""; else {
          l && (this.track || document.body).prepend(r), o = r.getBoundingClientRect()[s] * Math.max(1, (null === (i = window.visualViewport) || undefined === i ? undefined : i.scale) || 1);
          let t = r[this.isHorizontal ? "offsetWidth" : "offsetHeight"];
          t - 1 > o && (o = t);
        }
        const c = getComputedStyle(r);
        return "content-box" === c.boxSizing && (this.isHorizontal ? (o += parseFloat(c.paddingLeft) || 0, o += parseFloat(c.paddingRight) || 0) : (o += parseFloat(c.paddingTop) || 0, o += parseFloat(c.paddingBottom) || 0)), a = parseFloat(c[this.isHorizontal ? "marginRight" : "marginBottom"]) || 0, l ? null === (n = r.parentElement) || undefined === n || n.removeChild(r) : t.el || r.remove(), {dim: e(o, 1e3), gap: e(a, 1e3)};
      }
      getBounds() {
        const {isInfinite: t, isRTL: e, isHorizontal: i, pages: n} = this;
        let s = {min: 0, max: 0};
        if (t) s = {min: -Infinity, max: Infinity}; else if (n.length) {
      ...
      transitionTo(t = 0, e = this.option("transition")) {
        ...
        if (!l || !r[c] || r.length < 2 || Math.abs(((null === (n = null === (i = r[a]) || undefined === i ? undefined : i.slides[0]) || undefined === n ? undefined : n.dim) || 0) - this.viewportDim) > 1) return false;
        let h = t > a ? 1 : -1;
        this.isInfinite && (0 === a && t === r.length - 1 && (h = -1), a === r.length - 1 && 0 === t && (h = 1));
        const d = r[c].pos * (this.isRTL ? 1 : -1);
        if (a === c && Math.abs(d - l.target[this.axis]) < 1) return false;
        this.clearTransitions();
        const u = l.isResting;
        C(this.container, this.cn("inTransition"));
        const p = (null === (s = r[a]) || undefined === s ? undefined : s.slides[0]) || null, f = (null === (o = r[c]) || undefined === o ? undefined : o.slides[0]) || null;
        this.inTransition.add(f.index), this.createSlideEl(f);
        let g = p.el, m = f.el;
        u || e === Q || (e = "fadeFast", g = null);
        const v = this.isRTL ? "next" : "prev", b = this.isRTL ? "prev" : "next";
        return g && (this.inTransition.add(p.index), p.transition = e, g.addEventListener(K, this.onAnimationEnd), g.classList.add(`f-${e}Out`, `to-${h > 0 ? b : v}`)), m && (f.transition = e, m.addEventListener(K, this.onAnimationEnd), m.classList.add(`f-${e}In`, `from-${h > 0 ? v : b}`)), l.current[this.axis] = d, l.target[this.axis] = d, l.requestTick(), this.onChange(c), true;
      }
      ...
      flipInfiniteTrack() {
        ...
        if (!a || !i) return;
        let r = a.current[t], l = a.target[t] - r, c = 0, h = 0.5 * s;
      ...
      lazyLoadImg(t, e) {
        ...
        let a = false, r = null;
        const l = () => {
          a || (a = true, r && (r.remove(), r = null), P(e, o), e.complete && (C(e, n), setTimeout(() => {
            P(e, n);
      ...
      onAnimationEnd(t) {
        ...
        a && o.substring(0, a.length + 2) === `f-${a}` && this.inTransition.delete(n), this.inTransition.size || this.clearTransitions(), n === this.page && (null === (e = this.panzoom) || undefined === e ? undefined : e.isResting) && this.emit("settle");
      }
      onDecel(t, e = 0, i = 0, n = 0, s = 0) {
        ...
        Math.abs(d) > 5 ? (l[u].dim < document.documentElement["client" + (this.isHorizontal ? "Width" : "Height")] - 1 && (u = g), u = o && a ? d < 0 ? u - 1 : u + 1 : d < 0 ? u + 1 : u - 1) : u = 0 === n && 0 === s ? u : g, this.slideTo(u, {transition: false, friction: t.option("decelFriction")});
      }
      onClick(t) {
        const e = t.target, i = e && S(e) ? e.dataset : null;
        let n, s;
        i && (undefined !== i.carouselPage ? (s = "slideTo", n = i.carouselPage) : undefined !== i.carouselNext ? s = "slideNext" : undefined !== i.carouselPrev && (s = "slidePrev")), s ? (t.preventDefault(), t.stopPropagation(), e && !e.hasAttribute("disabled") && this[s](n)) : this.emit("click", t);
      }
      onSlideTo(t) {
        const e = t.detail || 0;
      ...
      onRefresh() {
        ...
        this.updateMetrics(), this.contentDim === t && this.viewportDim === e || this.slideTo(this.page, {friction: 0, transition: false});
      }
      onScroll() {
        var t;
        null === (t = this.viewport) || undefined === t || t.scroll(0, 0);
      }
      onResize() {
      ...
      slideTo(t = 0, {friction: e = this.option("friction"), transition: i = this.option("transition")} = {}) {
        ...
        if (!l || !c) return;
        if (this.page !== n) {
          const e = new Event("beforeChange", {bubbles: true, cancelable: true});
      ...
      addSlide(t, e) {
        var i, n, s, o;
        const a = this.panzoom, r = (null === (i = this.pages[this.page]) || undefined === i ? undefined : i.pos) || 0, l = (null === (n = this.pages[this.page]) || undefined === n ? undefined : n.dim) || 0, c = this.contentDim < this.viewportDim;
        ...
        if (this.page >= t && (this.page += d.length), this.updateMetrics(), a) {
          const e = (null === (s = this.pages[this.page]) || undefined === s ? undefined : s.pos) || 0, i = (null === (o = this.pages[this.page]) || undefined === o ? undefined : o.dim) || 0, n = this.pages.length || 1, h = this.isRTL ? l - i : i - l, d = this.isRTL ? r - e : e - r;
      ...
      removeSlide(t) {
        ...
        if (i) {
          this.removeSlideEl(i, true), this.slides.splice(t, 1);
          for (let t = 0; t < this.slides.length; t++) this.slides[t].index = t;
      ...
      updateMetrics() {
        ...
        if (i) {
          let t = Math.max(i[l], e(i.getBoundingClientRect()[r], 1e3)), n = getComputedStyle(i), s = "padding", a = o ? "Right" : "Bottom";
      ...
      getProgress(t, i = false, n = false) {
        undefined === t && (t = this.page);
        ...
        this.isInfinite && true !== n && (h = e((l - r.pos + a) / (1 * r.dim), 1e3), d = e((l - r.pos - a) / (1 * r.dim), 1e3));
      ...
      getVisibleSlides(t = 0) {
        ...
        if (o) {
          s = s + (null === (e = this.slides[this.slides.length - 1]) || undefined === e ? undefined : e.gap) || 0;
          let l = 0;
      ...
      destroy() {
        ...
        t.removeEventListener("click", this.onClick, {passive: false, capture: false}), t.removeEventListener("slideTo", this.onSlideTo), window.removeEventListener("resize", this.onResize), s && (s.destroy(), this.panzoom = null), n && n.forEach(t => {
    ...
    let nt;
    const st = ["a[href]", "area[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden]):not(.fancybox-focus-guard)", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"]):not([disabled]):not([aria-hidden])'].join(","), ot = t => {
      if (t && it) {
        undefined === nt && document.createElement("div").focus({get preventScroll() {
          return nt = true, false;
        }});
        try {
          if (nt) t.focus({preventScroll: true}); else {
      ...
      const t = document;
      let e, i = "", n = "", s = "";
      return t.fullscreenEnabled ? (i = "requestFullscreen", n = "exitFullscreen", s = "fullscreenElement") : t.webkitFullscreenEnabled && (i = "webkitRequestFullscreen", n = "webkitExitFullscreen", s = "webkitFullscreenElement"), i && (e = {request: function (e = t.documentElement) {
    ...
    const ft = () => {
      ...
      if (i) {
        ...
        if (n && s) {
          let o = s.slug || undefined, a = s.triggerEl || undefined;
      ...
      if (i && i.dispatchEvent(new CustomEvent("click", {bubbles: true, cancelable: true})), Ae.getInstance()) return;
      const n = document.querySelectorAll(`[data-fancybox="${t}"]`);
      n.length && (i = n[e - 1], i && i.dispatchEvent(new CustomEvent("click", {bubbles: true, cancelable: true})));
    }, vt = () => {
      if (false === Ae.defaults.Hash) return;
      const t = Ae.getInstance();
      if (false === (null == t ? undefined : t.options.Hash)) return;
      const {slug: e, index: i} = gt(), {slug: n} = ft();
      t && (e === n ? t.jumpTo(i - 1) : (dt = true, t.close())), mt();
    }, bt = () => {
    ...
    class xt extends $ {
      ...
      onRemoveSlide(t, e, i) {
        i.panzoom && i.panzoom.destroy(), i.panzoom = undefined, i.imageEl = undefined;
      }
      onChange(t, e, i, n) {
      ...
      onClose() {
        ...
        1 === ((null === (t = window.visualViewport) || undefined === t ? undefined : t.scale) || 1) && Object.assign(i.style, {position: "absolute", top: `${i.offsetTop + window.scrollY}px`, left: `${i.offsetLeft + window.scrollX}px`, bottom: "auto", right: "auto", width: `${c.width}px`, height: `${c.height}px`, overflow: "hidden"});
        ...
        a.on("endAnimation", () => {
          e.destroy();
        }), a.target.a = u, a.target.b = 0, a.target.c = 0, a.target.d = u, a.panTo({x: h, y: d, scale: u, friction: p ? 0.2 : 0.33, ignoreBounds: true}), a.isResting && e.destroy();
      }
      setImage(t, e) {
        ...
        t.src = e, this.process(t, e).then(e => {
          ...
          if (o && r) {
            ...
            const n = this.optionFor(t, "initialSize"), s = this.optionFor(t, "zoom"), o = {event: i.prevMouseMoveEvent || i.options.event, friction: s ? 0.12 : 0};
            let a = i.optionFor(t, "showClass") || undefined, r = true;
            i.isOpeningSlide(t) && ("full" === n ? e.zoomToFull(o) : "cover" === n ? e.zoomToCover(o) : "max" === n ? e.zoomToMax(o) : r = false, e.stop("current")), r && a && (a = e.isDragging ? "f-fadeIn" : ""), i.hideLoading(t), i.revealContent(t, a);
          }
          var l;
        }, () => {
        ...
        return new Promise((i, n) => {
          ...
          if ("string" == typeof l && (l = s(l)), !l || !S(l)) {
            if (l = document.createElement("img"), l instanceof HTMLImageElement) {
              let i = "", n = t.caption;
              i = "string" == typeof n && n ? n.replace(/<[^>]+>/gi, "").substring(0, 1e3) : `Image ${t.index + 1} of ${(null === (o = a.carousel) || undefined === o ? undefined : o.pages.length) || 1}`, l.src = e || "", l.alt = i, l.draggable = false, t.srcset && l.setAttribute("srcset", t.srcset), this.instance.isOpeningSlide(t) && (l.fetchPriority = "high");
            }
            t.sizes && l.setAttribute("sizes", t.sizes);
          }
          C(l, "fancybox-image"), t.imageEl = l, a.setContent(t, l, false);
          t.panzoom = new D(r, p({transformParent: true}, this.option("Panzoom") || {}, {content: l, width: (e, i) => a.optionFor(t, "width", "auto", i) || "auto", height: (e, i) => a.optionFor(t, "height", "auto", i) || "auto", wheel: () => {
            const t = a.option("wheel");
            return ("zoom" === t || "pan" == t) && t;
          }, click: (e, i) => {
            var n, s;
            if (a.isCompact || a.isClosing()) return false;
            if (t.index !== (null === (n = a.getSlide()) || undefined === n ? undefined : n.index)) return false;
            if (i) {
              const t = i.composedPath()[0];
              if (["A", "BUTTON", "TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].includes(t.nodeName)) return false;
            }
            let o = !i || i.target && (null === (s = t.contentEl) || undefined === s ? undefined : s.contains(i.target));
            return a.option(o ? "contentClick" : "backdropClick") || false;
          }, dblClick: () => a.isCompact ? "toggleZoom" : a.option("contentDblClick") || false, spinner: false, panOnlyZoomed: true, wheelLimit: Infinity, on: {ready: t => {
            i(t);
          }, error: () => {
            n();
          }, destroy: () => {
      ...
      zoomIn(t) {
        return new Promise((e, i) => {
          ...
          o.on("endAnimation", f), o.on("touchStart", f), o.on("afterTransform", p), o.on(["error", "destroy"], () => {
            i();
          }), o.panTo({x: c, y: h, scale: d, friction: 0, ignoreBounds: true}), o.stop("current");
          const g = {event: "mousemove" === o.panMode ? n.prevMouseMoveEvent || n.options.event : undefined}, m = this.optionFor(t, "initialSize");
      ...
      getZoomInfo(t) {
        ...
        if (!e || !i || !n || !s || et(n) < 3 || !this.optionFor(t, "zoom") || !a || o.state === lt.Destroy) return false;
        if ("0" === getComputedStyle(a).getPropertyValue("--f-images-zoom")) return false;
        const r = window.visualViewport || null;
        if (1 !== (r ? r.scale : 1)) return false;
        let {top: l, left: c, width: h, height: d} = n.getBoundingClientRect(), {top: u, left: p, fitWidth: f, fitHeight: g} = s.contentRect;
        if (!(h && d && f && g)) return false;
        const m = s.container.getBoundingClientRect();
        p += m.left, u += m.top;
        const v = -1 * (p + 0.5 * f - (c + 0.5 * h)), b = -1 * (u + 0.5 * g - (l + 0.5 * d)), y = h / f;
        let w = this.option("zoomOpacity") || false;
    ...
    class zt extends $ {
      ...
      onClearContent(t, e) {
        ...
        }, 0), e.contentEl = undefined, e.placeholderEl = undefined; else for (; e.el && e.el.firstChild;) e.el.removeChild(e.el.firstChild);
      }
      onSelectSlide(t, e, i) {
      ...
      onUnselectSlide(t, e, i) {
        ...
        if (i.type === Mt) {
          try {
            null === (s = null === (n = i.el) || undefined === n ? undefined : n.querySelector("video")) || undefined === s || s.pause();
          } catch (t) {}
          return;
        }
        let o;
      ...
      setIframeContent(t) {
        ...
        if ("iframe" !== t.type || false === o) return s.setAttribute("src", t.src + ""), n.setContent(t, s, false), this.resizeIframe(t), void n.revealContent(t);
        n.showLoading(t), s.onload = () => {
          if (!s.src.length) return;
          const e = "true" !== s.dataset.ready;
          s.dataset.ready = "true", this.resizeIframe(t), e ? n.revealContent(t) : n.hideLoading(t);
        }, s.setAttribute("src", e), n.setContent(t, s, false);
      }
      resizeIframe(t) {
        const {type: e, iframeEl: i} = t;
        if (e === Ct || e === Tt) return;
        const n = null == i ? undefined : i.parentElement;
        if (!i || !n) return;
        let s = t.autoSize;
        undefined === s && (s = this.optionFor(t, "autoSize"));
        let o = t.width || 0, a = t.height || 0;
        o && a && (s = false);
        const r = n && n.style;
        if (false !== t.preload && false !== s && r) try {
      ...
      playVideo() {
        ...
        const i = () => {
          if (t.iframeEl && t.iframeEl.contentWindow) {
            let e;
            if ("true" === t.iframeEl.dataset.ready) return e = t.type === Ct ? {event: "command", func: "playVideo"} : {method: "play", value: "true"}, e && t.iframeEl.contentWindow.postMessage(JSON.stringify(e), "*"), void (t.poller = undefined);
      ...
      processType(t) {
        ...
        if (n = e.match(/(youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|shorts\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i)) {
          const s = this.optionFor(t, Ct), {nocookie: o} = s, a = function (t, e) {
            ...
            return i;
          }(s, ["nocookie"]), r = `www.youtube${o ? "-nocookie" : ""}.com`, l = Ot(e, a), c = encodeURIComponent(n[2]);
    ...
    class Dt extends $ {
      ...
      onMouseLeave() {
        var t;
        this.inHover = false, (null === (t = this.instance.panzoom) || undefined === t ? undefined : t.isResting) && this.resume();
      }
      onTimerEnd() {
      ...
      createProgressBar() {
        ...
        const e = this.instance, i = (null === (t = e.pages[e.page]) || undefined === t ? undefined : t.slides) || [];
      ...
      stop() {
        ...
        t.clear(), t.state = It, i.removeEventListener("mouseenter", t.onMouseEnter, false), i.removeEventListener("mouseleave", t.onMouseLeave, false), document.removeEventListener("visibilitychange", t.onVisibilityChange, false), P(i, "has-autoplay"), e !== It && t.emit("stop");
      }
      pause() {
        const t = this;
      ...
      resume() {
        ...
        if (e.isInfinite || e.page !== e.pages.length - 1) if (t.state !== Rt) {
          if (t.state === kt && !t.inHover) {
            const e = new Event("resume", {bubbles: true, cancelable: true});
    ...
    class Ft extends $ {
      ...
      onPrepare(t) {
        ...
        if (!e) return;
        const i = t.container;
        i && (e.options.Autoplay = p({autoStart: false}, this.option("Autoplay") || {}, {pauseOnHover: false, timeout: this.option("timeout"), progressParentEl: () => this.option("progressParentEl") || null, on: {start: () => {
          t.emit("startSlideshow");
        }, set: e => {
          var n;
          i.classList.add("has-slideshow"), (null === (n = t.getSlide()) || undefined === n ? undefined : n.state) !== ct.Ready && e.pause();
        }, stop: () => {
          i.classList.remove("has-slideshow"), t.isCompact || t.endIdle(), t.emit("endSlideshow");
        }, resume: (e, i) => {
          var n, s, o;
          !i || !i.cancelable || (null === (n = t.getSlide()) || undefined === n ? undefined : n.state) === ct.Ready && (null === (o = null === (s = t.carousel) || undefined === s ? undefined : s.panzoom) || undefined === o ? undefined : o.isResting) || i.preventDefault();
      ...
      onKeydown(t, e) {
        var i;
        const n = this.ref;
        n && e === this.option("key") && "BUTTON" !== (null === (i = document.activeElement) || undefined === i ? undefined : i.nodeName) && n.toggle();
      }
      attach() {
        const t = this, e = t.instance;
    ...
    Object.defineProperty(Ft, "defaults", {enumerable: true, configurable: true, writable: true, value: {key: " ", playOnStart: false, progressParentEl: t => {
      var e;
      return (null === (e = t.instance.container) || undefined === e ? undefined : e.querySelector(".fancybox__toolbar [data-fancybox-toggle-slideshow]")) || t.instance.container;
    }, timeout: 3e3}});
    ...
    let Wt = class extends $ {
      ...
      onInitSlide(t, e) {
        const i = e.el ? e.el.dataset : undefined;
      ...
      onChange() {
        ...
        const e = this.container, i = this.instance, n = i.panzoom, s = this.carousel, o = s ? s.panzoom : null, r = i.page;
        if (n && s && o) {
          if (n.isDragging) {
            P(e, this.cn(Ht));
            let n = (null === (t = s.pages[r]) || undefined === t ? undefined : t.pos) || 0;
      ...
      build() {
        ...
        let l = null == o ? undefined : o.querySelector("." + a);
      ...
      getShift(t) {
        ...
        if (!(null === (e = s.slides[t]) || undefined === e ? undefined : e.el)) return 0;
        const c = 0.5 * (o - a), h = n.pages.length - 1;
        let d = n.getProgress(0), u = n.getProgress(h), p = n.getProgress(t, false, true), f = 0, g = c + l + r;
      ...
      setProps(t) {
        ...
        if (s && o) {
          const a = null === (i = o.slides[t]) || undefined === i ? undefined : i.el;
    ...
    class Vt extends $ {
      ...
      onCreateSlide(t, e) {
        var i, n, s;
        const o = (null === (s = null === (n = null === (i = this.instance) || undefined === i ? undefined : i.carousel) || undefined === n ? undefined : n.slides[e.index]) || undefined === s ? undefined : s.type) || "", a = e.el;
        if (a && o) {
          let t = `for-${o}`;
      ...
      onInit() {
        ...
        if (!s) return;
        const o = p({}, e.options, {parentEl: s, classes: {container: "f-thumbs fancybox__thumbs"}, Carousel: {Sync: {friction: i.option("Carousel.friction") || 0}}, on: {ready: t => {
          const i = t.container;
          i && this.hidden && (e.refresh(), i.style.transition = "none", e.hide(), i.offsetHeight, queueMicrotask(() => {
            i.style.transition = "", e.show();
          }));
        }}});
        o.Carousel = o.Carousel || {}, o.Carousel.on = p((null === (t = e.options.Carousel) || undefined === t ? undefined : t.on) || {}, {click: this.onClick, createSlide: this.onCreateSlide}), n.options.Thumbs = o, n.attachPlugins({Thumbs: Wt}), e.ref = n.plugins.Thumbs, e.option("showOnStart") || (e.ref.state = Bt.Hidden, e.hidden = true);
      }
      onResize() {
        var t;
        const e = null === (t = this.ref) || undefined === t ? undefined : t.container;
        e && (e.style.maxHeight = "");
      }
      onKeydown(t, e) {
      ...
      show() {
        ...
        const e = t.container;
        e && (this.refresh(), e.offsetHeight, e.removeAttribute(Yt), e.classList.remove(qt), this.hidden = false);
      }
      hide() {
        const t = this.ref, e = t && t.container;
        e && (this.refresh(), e.offsetHeight, e.classList.add(qt), e.setAttribute(Yt, "true")), this.hidden = true;
      }
      refresh() {
        const t = this.ref;
        if (!t || !t.state) return;
        const e = t.container, i = (null == e ? undefined : e.firstChild) || null;
      ...
      detach() {
        ...
        i.off("Carousel.init", e.onInit), i.off("resize", e.onResize), i.off("keydown", e.onKeydown), null === (t = i.carousel) || undefined === t || t.detachPlugins(["Thumbs"]), e.ref = null;
      }
    }
    ...
    class te extends $ {
      ...
      onReady(t) {
        ...
        if (i) for (const t of ["left", "middle", "right"]) for (const n of i[t]) {
          ...
          i && (null === (e = a[t]) || undefined === e || e.push(i), o++);
        }
        let r = null;
        if (o && (r = this.createContainer()), r) {
          for (const [t, e] of Object.entries(a)) {
            ...
            "auto" !== n || "middle" !== t || e.length || (n = true), r.appendChild(i);
          }
          true === n && C(r, "is-absolute"), this.state = Ut.Ready, this.onRefresh();
        } else this.state = Ut.Disabled;
      }
      onClick(t) {
        var e, i;
        const n = this.instance, s = n.getSlide(), o = null == s ? undefined : s.panzoom, a = t.target, r = a && S(a) ? a.dataset : null;
        if (!r) return;
        if (undefined !== r.fancyboxToggleThumbs) return t.preventDefault(), t.stopPropagation(), void (null === (e = n.plugins.Thumbs) || undefined === e || e.toggle());
        if (undefined !== r.fancyboxToggleFullscreen) return t.preventDefault(), t.stopPropagation(), void this.instance.toggleFullscreen();
        if (undefined !== r.fancyboxToggleSlideshow) {
          t.preventDefault(), t.stopPropagation();
          const e = null === (i = n.carousel) || undefined === i ? undefined : i.plugins.Autoplay;
          let s = e.isActive;
      ...
      onDone(t, e) {
        var i;
        null === (i = e.panzoom) || undefined === i || i.on("afterTransform", () => {
      ...
      createContainer() {
        ...
        return i || (i = document.createElement("div"), C(i, Qt), e.prepend(i)), i.addEventListener("click", this.onClick, {passive: false, capture: true}), t && C(t, Jt), this.container = i, i;
      }
      createEl(t) {
        ...
        if (undefined !== Zt[t] && !a) return null;
        ...
        const l = null == n ? undefined : n.querySelector("svg");
      ...
      onChange(t) {
        ...
        n && (ht = i === e ? "" : i), e && e !== i && (pt = setTimeout(() => {
          try {
            if (t.state === lt.Ready) {
              let t = "replaceState";
              n && !ut && (t = "pushState", ut = true), window.history[t]({}, document.title, window.location.pathname + window.location.search + e);
            }
          } catch (t) {}
        }, 300));
      }
    ...
    class Ae extends m {
      ...
      initLayout() {
        ...
        if (n) {
          if (n.setAttribute("id", `fancybox-${this.id}`), n.setAttribute("aria-label", this.localize("{{MODAL}}")), n.classList.toggle(ce, this.isCompact), C(n, this.option("mainClass") || ""), C(n, de), this.container = n, this.footer = n.querySelector(".fancybox__footer"), i.appendChild(n), C(document.documentElement, ie), xe && Ee || (xe = document.createElement("span"), C(xe, "fancybox-focus-guard"), xe.setAttribute(fe, "0"), xe.setAttribute(ae, "true"), xe.setAttribute("aria-label", "Focus guard"), Ee = xe.cloneNode(), null === (t = n.parentElement) || undefined === t || t.insertBefore(xe, n), null === (e = n.parentElement) || undefined === e || e.append(Ee)), n.addEventListener("mousedown", t => {
      ...
      initCarousel(t) {
        ...
        s.on("*", (t, e, ...i) => {
          ...
          this.clearContent(i), i.state = undefined;
        }), s.on("Panzoom.touchStart", () => {
          var t, e;
          this.isCompact || this.endIdle(), (null === (t = document.activeElement) || undefined === t ? undefined : t.closest(".f-thumbs")) && (null === (e = this.container) || undefined === e || e.focus());
        }), s.on("settle", () => {
          ...
          if (s) {
            const t = Math.abs(e.current.f), i = t < 1 ? "" : Math.max(0.5, Math.min(1, 1 - t / e.contentRect.fitHeight * 1.5));
          ...
          if (o && i(o.el)) return;
          if (e.isMobile && document.activeElement && -1 !== ["TEXTAREA", "INPUT"].indexOf(null === (s = document.activeElement) || undefined === s ? undefined : s.nodeName)) return;
          const a = Math.abs(e.dragOffset.y);
          "y" === e.lockedAxis && (a >= 200 || a >= 50 && e.dragOffset.time < 300) && (n && n.cancelable && n.preventDefault(), this.close(n, "f-throwOut" + (e.current.f < 0 ? "Up" : "Down")));
        })), s.on("change", t => {
          var e;
          let i = null === (e = this.getSlide()) || undefined === e ? undefined : e.triggerEl;
          if (i) {
            const e = new CustomEvent("slideTo", {bubbles: true, cancelable: true, detail: t.page});
            i.dispatchEvent(e);
          }
      ...
      attachEvents() {
        ...
        if (!e) return;
        e.addEventListener("click", t.onClick, {passive: false, capture: false}), e.addEventListener("wheel", t.onWheel, {passive: false, capture: false}), document.addEventListener("keydown", t.onKeydown, {passive: false, capture: true}), document.addEventListener("visibilitychange", t.onVisibilityChange, false), document.addEventListener("mousemove", t.onMousemove), t.option("trapFocus") && document.addEventListener("focus", t.onFocus, true), window.addEventListener("resize", t.onResize);
      ...
      detachEvents() {
        const t = this, e = t.container;
        if (!e) return;
        document.removeEventListener("keydown", t.onKeydown, {passive: false, capture: true}), e.removeEventListener("wheel", t.onWheel, {passive: false, capture: false}), e.removeEventListener("click", t.onClick, {passive: false, capture: false}), document.removeEventListener("mousemove", t.onMousemove), window.removeEventListener("resize", t.onResize);
        const i = window.visualViewport;
        i && (i.removeEventListener("resize", t.onResize), i.removeEventListener("scroll", t.onResize)), document.removeEventListener("visibilitychange", t.onVisibilityChange, false), document.removeEventListener("focus", t.onFocus, true);
      }
      scale() {
        const t = this.container;
        if (!t) return;
        const e = window.visualViewport, i = Math.max(1, (null == e ? undefined : e.scale) || 1);
        let n = "", s = "", o = "";
        if (e && i > 1) {
      ...
      onClick(t) {
        ...
        if (n && "image" === (null === (e = this.getSlide()) || undefined === e ? undefined : e.type)) return void (this.clickTimer ? (clearTimeout(this.clickTimer), this.clickTimer = null) : this.clickTimer = setTimeout(() => {
      ...
      manageCloseBtn(t) {
        const e = this.optionFor(t, "closeButton") || false;
        if ("auto" === e) {
      ...
      manageCaption(t = undefined) {
        var e, i;
        const n = "fancybox__caption", s = this.container;
        if (!s) return;
        P(s, ue);
        const o = this.isCompact || this.option("commonCaption"), a = !o;
        if (this.caption && this.stop(this.caption), a && this.caption && (this.caption.remove(), this.caption = null), o && !this.caption) for (const t of (null === (e = this.carousel) || undefined === e ? undefined : e.slides) || []) t.captionEl && (t.captionEl.remove(), t.captionEl = undefined, P(t.el, ue), null === (i = t.el) || undefined === i || i.removeAttribute("aria-labelledby"));
      ...
      focus(t) {
        ...
        const i = document.activeElement || null, n = (null == t ? undefined : t.target) || null, s = this.container, o = null === (e = this.carousel) || undefined === e ? undefined : e.viewport;
        if (!s || !o) return;
        ...
        for (let t of l) {
          ...
          if (t === s || (i || n) && !e) {
            ...
            undefined !== e && e && (t.tabIndex = parseFloat(e)), t.removeAttribute("data-orig-tabindex"), !t.hasAttribute("autoFocus") && h || (h = t);
          } else {
            const e = undefined === t.dataset.origTabindex ? t.getAttribute("tabindex") || "" : t.dataset.origTabindex;
            e && (t.dataset.origTabindex = e), t.tabIndex = -1;
          }
        }
        let d = null;
        t ? (!n || c.indexOf(n) < 0) && (d = h || s, c.length && (i === Ee ? d = c[0] : this.lastFocus !== s && i !== xe || (d = c[c.length - 1]))) : d = a && "image" === a.type ? s : h || s, d && ot(d), this.lastFocus = document.activeElement, this.ignoreFocusChange = false;
      }
      next() {
      ...
      isTopmost() {
        var t;
        return (null === (t = Ae.getInstance()) || undefined === t ? undefined : t.id) == this.id;
      }
      animate(t = null, e = "", i) {
      ...
      stop(t) {
        t && t.dispatchEvent(new CustomEvent("animationend", {bubbles: false, cancelable: true, currentTarget: t}));
      }
      ...
      revealContent(t, e) {
        ...
        i && n && (this.emit("reveal", t), this.hideLoading(t), t.state = ct.Opening, (e = this.isOpeningSlide(t) ? undefined === e ? this.optionFor(t, "showClass") : e : "f-fadeIn") ? this.animate(n, e, () => {
          this.done(t);
        }) : this.done(t));
      }
      done(t) {
        this.isClosing() || (t.state = ct.Ready, this.emit("done", t), C(t.el, "is-done"), this.isCurrentSlide(t) && this.option("autoFocus") && queueMicrotask(() => {
          var e;
          null === (e = t.panzoom) || undefined === e || e.updateControls(), this.option("autoFocus") && this.focus();
      ...
      isOpeningSlide(t) {
        var e, i;
        return null === (null === (e = this.carousel) || undefined === e ? undefined : e.prevPage) && t && t.index === (null === (i = this.getSlide()) || undefined === i ? undefined : i.index);
      }
      showLoading(t) {
        t.state = ct.Loading;
        const e = t.el;
      ...
      clearContent(t) {
        if (undefined === t.state) return;
        this.emit("clearContent", t), t.contentEl && (t.contentEl.remove(), t.contentEl = undefined);
        const e = t.el;
        e && (P(e, "has-error"), P(e, "has-unknown"), P(e, `has-${t.type || "unknown"}`)), t.closeBtnEl && t.closeBtnEl.remove(), t.closeBtnEl = undefined, t.captionEl && t.captionEl.remove(), t.captionEl = undefined, t.spinnerEl && t.spinnerEl.remove(), t.spinnerEl = undefined;
      }
      getSlide() {
        var t;
        const e = this.carousel;
        return (null === (t = null == e ? undefined : e.pages[null == e ? undefined : e.page]) || undefined === t ? undefined : t.slides[0]) || undefined;
      }
      close(t, e) {
        if (this.isClosing()) return;
      ...
      proceedClose(t, e) {
        ...
        if (r && (et(r) ? ot(r) : r.focus()), s && (P(s, de), C(s, "is-closing"), s.setAttribute(ae, "true"), this.option("animated") && C(s, le), s.style.pointerEvents = "none"), o) {
          o.clearTransitions(), null === (i = o.panzoom) || undefined === i || i.destroy(), null === (n = o.plugins.Navigation) || undefined === n || n.detach();
          for (const t of o.slides) {
            t.state = ct.Closing, this.hideLoading(t);
            const e = t.contentEl;
            e && this.stop(e);
            const i = null == t ? undefined : t.panzoom;
            i && (i.stop(), i.detachEvents(), i.detachObserver()), this.isCurrentSlide(t) || o.emit("removeSlide", t);
          }
        }
        Ce = window.scrollX, Te = window.scrollY, window.addEventListener("scroll", this.onScroll), this.emit("close", t), this.state !== lt.CustomClosing ? (undefined === e && a && (e = this.optionFor(a, "hideClass")), e && a ? (this.animate(a.contentEl, e, () => {
      ...
      destroy() {
        var t;
        if (this.state === lt.Destroy) return;
        window.removeEventListener("scroll", this.onScroll), this.state = lt.Destroy, null === (t = this.carousel) || undefined === t || t.destroy();
        const e = this.container;
      ...
      static bind(t, e, i) {
        if (!it) return;
        let n, s = "", o = {};
        if (undefined === t ? n = document.body : be(t) ? (n = document.body, s = t, "object" == typeof e && (o = e || {})) : (n = t, be(e) && (s = e), "object" == typeof i && (o = i || {})), !n || !S(n)) return;
        s = s || "[data-fancybox]";
      ...
      static fromEvent(t) {
        ...
        return u && u.options.triggerEl && r.indexOf(u.options.triggerEl) > -1 ? undefined : (e && (l.startIndex = r.indexOf(e)), Ae.fromNodes(r, l));
      }
      static fromSelector(t, e, i) {
        let n = null, s = "", o = {};
        if (be(t) ? (n = document.body, s = t, "object" == typeof e && (o = e || {})) : t instanceof HTMLElement && be(e) && (n = t, s = e, "object" == typeof i && (o = i || {})), !n || !s) return false;
      ...
      static fromNodes(t, e) {
        ...
        const i = [];
        for (const n of t) {
          const t = n.dataset || {}, s = t[ve] || n.getAttribute(me) || n.getAttribute("currentSrc") || n.getAttribute(ve) || undefined;
          let o;
          const a = e.delegate;
          let r;
          a && i.length === e.startIndex && (o = a instanceof HTMLImageElement ? a : a.querySelector("img:not([aria-hidden])")), o || (o = n instanceof HTMLImageElement ? n : n.querySelector("img:not([aria-hidden])")), o && (r = o.currentSrc || o[ve] || undefined, !r && o.dataset && (r = o.dataset.lazySrc || o.dataset[ve] || undefined));
      ...
      static getSlide() {
        var t;
        return (null === (t = Ae.getInstance()) || undefined === t ? undefined : t.getSlide()) || null;
      }
      static show(t = [], e = {}) {
        return new Ae(t, e);
      }
